...
namespace Logger
{
    public class FileEventLogger : EventLoggerBase
    {
        #region Constants
        ...
        /// <summary>
        /// Constructs an object of type FileEventLogger.
        /// </summary>
        ...
        public FileEventLogger(string folderPath, int maxNumOfEntries, Action<Task> errorHandlingCallback) : base(errorHandlingCallback)
        {
        ...
        protected override void ProcessingQueue()
        {
            ...
            while (!LogEntries.IsCompleted)
            {
                ...
                if (LogEntries.TryTake(out LogEntry Entry, 50))
                {
                    ...
                    // If there is no log file present, create a new one. If there is log file present, count all lines inside of it
