...
namespace DataBaseView
{
	public partial class Form1 : Form
	{
		...
		string connectionstring = @"Data Source = AEM00224\HIDRIA_IA; Initial Catalog = Nasipavanje3; Integrated Security = true";
		//string connectionstring = @"Data Source = TCN860534\WINCCPLUSMIG2014; Initial Catalog = Nasipavanje3; Integrated Security = true";
