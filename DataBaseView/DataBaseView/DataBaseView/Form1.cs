...
namespace DataBaseView
{
	public partial class Form1 : Form
	{
		...
		static string catalog = ConfigurationManager.AppSettings["catalog"];

		// Connection String
        string connectionstring = @"Data Source = ROC843\HIDRIA_IA; Initial Catalog = ebike; Integrated Security = true";
		...
		private void comboBoxTable_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			//comboBoxTable.Items.Add("Products");
		}
	}
}
